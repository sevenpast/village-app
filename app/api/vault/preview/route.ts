...
/**
 * GET /api/vault/preview?url=...
 * Proxy endpoint to preview documents from Supabase Storage
 * Returns files with inline Content-Disposition for viewing in browser
 */
export async function GET(request: NextRequest) {
  try {
    ...
    // Return file with inline Content-Disposition for preview
